...
namespace Do_An.GUI
{
    public partial class ThanhToan : Form
    {
        ...
        private void AddDataGrid(int index)
        {
            ...
            dgvThanhToan.Rows[index].Cells[4].Value = lblKhuyenMai.Text;
            dgvThanhToan.Rows[index].Cells[5].Value = lblThanhTien.Text;
        }
        ...
        private void ComputeTongTien()
        {
            ...
            foreach (DataGridViewRow row in dgvThanhToan.Rows)
            {
                sum += int.Parse(row.Cells[5].Value.ToString());
            }
        ...
        public string GenerateInvoiceNumber()
        {
            ...
            string prefix = "HD";
            string number = (sanPhamService.CountSP()+1).ToString();
            maSp = prefix + number;
